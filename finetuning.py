...
from src.tasks.infer import FewRel, infer_from_trained
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--task", type=str, default="semeval", help="semeval, fewrel"
    )
    parser.add_argument(
        "--train_data",
        type=str,
    ...
    parser.add_argument(
        "--num_epochs", type=int, default=11, help="No of epochs"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--train", type=int, default=1, help="0: Don't train, 1: train"
    )
    parser.add_argument(
        "--infer", type=int, default=1, help="0: Don't infer, 1: Infer"
    )
